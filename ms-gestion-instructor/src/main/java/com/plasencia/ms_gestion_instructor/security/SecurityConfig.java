...
/**
 * Seguridad del microservicio de instructores. Toda peticion debe traer un JWT
 * valido. Las lecturas las puede hacer cualquier usuario autenticado; las
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html")
                                .permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/instructores/**").authenticated()
                        .requestMatchers("/api/instructores/**").hasAnyRole("INSTRUCTOR", "ADMIN")
